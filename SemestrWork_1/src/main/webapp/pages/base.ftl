...
<head>
    ...
    <style>
        body {
            background: white url(/files/img7.png.jpg) repeat-x fixed;
            background-size: 80%;
        }
        ...
        .mainer {
            ...
            background-color: rgba(255, 126, 22, 0.6);
            color: #ffffff;
        }
...
<nav class="navbar navbar-expand-sm navbar-custom">
    <a class="navbar-brand"><img alt="got_img" src="/files/img4.png" width="50" height="50" class="rounded-circle"
                                 style=""></a>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
            <a class="navbar-brand" href="/allUsers">Users</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="navbar-brand" href="/chronology">Сhronology</a>
        </li>
    </ul>
